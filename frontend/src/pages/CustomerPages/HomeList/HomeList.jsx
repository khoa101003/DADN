...
import { getPrivatePiece, delPieceById } from '../../../api/home_pieceApi';
...
function HomeList() {
    ...
    const newRegis = () => {
        navigate(`/${params.account}/home-regis`)
    }

    const detail = (gar) => {
        navigate(`/${params.account}/home-detail/${gar.id}`)
    }
