...
import { getPieceById, delPieceById } from '../../../api/home_pieceApi';
import { getPrivateRecord } from '../../../api/recordApi';
import { getCurValueTemp } from '../../../api/adafruitApi';
import { deleteHomeRequest } from '../../../api/requestApi';
...
function HomeDetail() {
    ...
    useEffect(() => {
        if (sendReq) {
            const x = deleteHomeRequest(dataSend);
            if (x) {
                setSuccess(true)
                setSendReq(false)
            }
                ...
                <Container className='justify-content-center'>
                    ...
                    >
                        <Modal.Header closeButton>
                            <Modal.Title>Xóa ngôi nhà thành công</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>Ngôi nhà đã được xóa</Modal.Body>
                        <Modal.Footer>
                    ...
                    >
                        ...
                        <Modal.Body>Hãy chắc chắn bạn muốn gửi yêu cầu xóa ngôi nhà này</Modal.Body>
                        <Modal.Footer>
                            ...
                            <Row className='my-5'>
                                ...
                                <Col xs={{ span: 7, offset: 1 }}>
                                    <Row className={cx('control')}>
                                        ...
                                        <Col xs='6'><Button variant="success" style={ButtonStyled} href={`/${params.account}/controlPump/${params.id}`}>Quản lí quạt</Button></Col>
                                        ...
                                        <Col xs='6'><Button variant="success" style={ButtonStyled} href={`/${params.account}/dashboard/${params.id}`}>Giám sát ngôi nhà</Button></Col>
                                    </Row>
                                </Col>
                            </Row>
                            ...
                            <div className={cx('edit-del')}>
                                <Row>
                                    <Col xs={{ span: 2, offset: 3 }}>
                                        <Button variant="primary" style={{ width: "100%" }} href={`/${params.account}/home-mod/${params.id}`}>Sửa thông tin</Button>
                                    </Col>
